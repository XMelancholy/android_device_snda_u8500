...
# 4.4.3 Need //Fix Camera error
# hardware/snda/display/libcamera/Android.mk
STE_CAMERA_JHEAD := true
...
# -DSCREENSHOT_CLIENT_STRIDE_HACK
...
BOARD_CUSTOM_GRAPHICS := ../../../device/snda/u8500/recovery/graphics_cn.c
BOARD_USE_CUSTOM_RECOVERY_FONT := \"fontcn_15x40.h\"
...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=s1w_u8500 BUILD_FINGERPRINT=Bambookphone/s1w_u8500/u8500:4.4.3/NS4.1/13436:user/release-keys PRIVATE_BUILD_DESC="s1w_u8500-user 4.4.3 NS4.1 13436 release-keys"
