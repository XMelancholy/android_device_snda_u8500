...
ifdef CONFIG_ENABLE_STE_CHANGES
L_CFLAGS += -DENABLE_STE_CHANGES
ENABLE_STE_CHANGES := y
endif

ifdef CONFIG_ANDROID_HEXDUMP_LOGS
L_CFLAGS += -DCONFIG_ANDROID_HEXDUMP_LOGS
endif
...
L_CFLAGS += -DCONFIG_DATA_PKT_FILTER
endif
endif
...
L_CFLAGS += -DCONFIG_STE_AUTOMATIC_REGULATORY_DOMAIN
endif
ifdef CONFIG_RSSI_FILTER
L_CFLAGS += -DCONFIG_RSSI_FILTER
endif
endif
...
ifdef ENABLE_STE_CHANGES
OBJS += wpa_supplicant_ste.c
ifdef CONFIG_STE_AUTOMATIC_REGULATORY_DOMAIN
OBJS += mcc2alpha2_ste.c
endif
endif
